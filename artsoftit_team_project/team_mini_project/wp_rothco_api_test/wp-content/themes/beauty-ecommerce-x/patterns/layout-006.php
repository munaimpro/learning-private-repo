...
/**
 * Title: Layout 006
 * Slug: beauty-ecommerce-x/layout-006
 * Categories: layouts
 */
?>
...
<div class="wp-block-column is-vertically-aligned-center superbthemes-navigation-004-columns-logo" style="flex-basis:25%"><!-- wp:site-title {"level":6,"style":{"typography":{"fontStyle":"normal","fontWeight":"600","fontSize":"20px"}},"fontFamily":"fontsecondary"} /--></div>
<!-- /wp:column -->
...
<figure class="wp-block-image size-full is-resized"><a href="#"><img src="<?php echo esc_url(get_stylesheet_directory_uri() . "/assets/images/navigation/icon-phone.png");?>" alt="" class="wp-image-2251" style="object-fit:cover;width:28px;height:28px"/></a></figure>
<!-- /wp:image --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
